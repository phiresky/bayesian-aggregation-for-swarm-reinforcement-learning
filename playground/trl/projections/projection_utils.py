...
from stable_baselines3.common.policies import (
    ActorCriticPolicy as AbstractGaussianPolicy,
)

from .torch_utils import torch_batched_trace
...
def get_entropy_schedule(schedule_type, total_train_steps, dim):
    ...
    if schedule_type == "linear":
        ...
        return lambda initial_entropy, target_entropy, temperature, step: ch.tensor(
            [-np.inf], device="cuda"
        )
